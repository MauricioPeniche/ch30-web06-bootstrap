...
// console.log(`Modelo : ${ carModel } Año : ${ carYear}`); // Vento
...
const [cociente, residuo] = divisionConResiduo(dividendo, divisor);

console.log(`El cociente de la division es ${cociente} y el residuo ${residuo}.`); */
